...
class InMemoryModerationLogServiceTest {
    ...
    void shouldReturnHistorySortedByTimestamp() throws InterruptedException {
        ...
        assertEquals("Third", history.get(0).getReason());
        assertEquals("Second", history.get(1).getReason());
        assertEquals("First", history.get(2).getReason());
    }
    ...
    void shouldFilterHistoryByActionType() {
        ...
        warns.forEach(action -> assertEquals(ActionType.WARN, action.getActionType()));
    }
    ...
    void shouldIsolateHistoryByGuild() {
        ...
        assertEquals(guild1, guild1History.get(0).getGuildId());
        assertEquals(guild2, guild2History.get(0).getGuildId());
    }
    ...
    void shouldIsolateHistoryByUser() {
        ...
        assertEquals(user1, user1History.get(0).getTargetUserId());
        assertEquals(user2, user2History.get(0).getTargetUserId());
    }
