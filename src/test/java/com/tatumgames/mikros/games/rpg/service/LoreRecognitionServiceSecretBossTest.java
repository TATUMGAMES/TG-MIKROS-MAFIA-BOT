...
class LoreRecognitionServiceSecretBossTest {
  ...
  @Mock private BossService bossService;
  ...
  void shouldTriggerSecretBossAtLevel20Milestone() {
    ...
    Boss mockBoss =
        BossCatalog.createBoss(BossCatalog.getRandomNormalBoss(10), 10, LIVABLE_SECONDS);
  ...
  void shouldTriggerSecretBossAtLevel30Milestone() {
    ...
    Boss mockBoss =
        BossCatalog.createBoss(BossCatalog.getRandomNormalBoss(15), 15, LIVABLE_SECONDS);
