...
public enum BiomeType {
    ...
    public String getAdvancementNarrative() {
        return switch (this) {
            ...
            case ANCIENT_RUINS -> "crumbling stone and forgotten runes emerge... history echoes around you";
            ...
            case MYSTICAL_HEIGHTS -> "the path climbs into mist and jagged peaks... the arcane hums in the air";
            case TWISTED_REALMS -> "reality bends and warps around you... portals flicker at the edges of vision";
        };
    }
}
