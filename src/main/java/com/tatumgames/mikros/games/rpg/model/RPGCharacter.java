...
public class RPGCharacter {
  ...
  private Instant
      diedAt; // When the character died (null if alive); used for 24h re-register window
  ...
  /**
   * Records that an action was performed (updates lastActionTime only). Charge deduction is handled
   * by the command before executing the action.
   */
