...
/**
 * Enum representing wandering figures that can be encountered during exploration. These are
 * ultra-rare encounters (0.5% chance) that provide unique rewards.
 */
public enum WanderingFigureType {
    ...
    WanderingFigureType(
            ...
            String outcome1Narrative,
            String outcome2Narrative,
            String outcome3Narrative) {
