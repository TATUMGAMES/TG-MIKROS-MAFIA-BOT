...
public class BattleAction implements CharacterAction {
  ...
  /**
   * Calculates enemy power based on level. Uses tiered scaling: early game unchanged, mid and late
   * game enemies are progressively stronger.
   */
    ...
    if (effective) {
      ...
      return switch (characterClass) {
        case WARRIOR, KNIGHT, OATHBREAKER ->
            switch (enemyType) {
              case MAGICAL ->
                  " Your physical attacks struggled against the enemy's magical defenses.";
        ...
        case MAGE, PRIEST, NECROMANCER ->
            switch (enemyType) {
              case CONSTRUCT ->
                  " Your magic had little effect on the construct's mechanical nature.";
