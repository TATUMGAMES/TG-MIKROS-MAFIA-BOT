...
/**
 * Utility class for biome-specific exploration narratives.
 * Categorizes existing exploration narratives by biome theme.
 */
public class BiomeLore {
    ...
    static {
        ...
        LORE_BY_BIOME.put(BiomeType.FROZEN_WASTES, Arrays.asList(
        ...
        // ANCIENT_RUINS - References to ruins, Shattering, Grand Library, Nil City, ancient civilizations
        LORE_BY_BIOME.put(BiomeType.ANCIENT_RUINS, Arrays.asList(
        ...
        LORE_BY_BIOME.put(BiomeType.SHADOWED_FORESTS, Arrays.asList(
        ...
        LORE_BY_BIOME.put(BiomeType.VOLCANIC_DEPTHS, Arrays.asList(
        ...
        LORE_BY_BIOME.put(BiomeType.MYSTICAL_HEIGHTS, Arrays.asList(
        ...
        LORE_BY_BIOME.put(BiomeType.TWISTED_REALMS, Arrays.asList(
