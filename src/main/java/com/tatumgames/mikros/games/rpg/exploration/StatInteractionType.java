...
/**
 * Enum representing stat-gated world interactions during exploration. These encounters require
 * minimum stat thresholds and provide meaningful success/failure outcomes.
 */
public enum StatInteractionType {
    ...
    BURIED_CACHE(
            "Buried Cache", "Something glints beneath the snow… or maybe it's nothing.", "LUCK", 10),
    MYSTERIOUS_GLIMMER(
            "Mysterious Glimmer",
    ...
    StatInteractionType(
            String displayName, String description, String requiredStat, int baseRequirement) {
    ...
    /**
     * Calculates the required stat value based on character level. Formula: baseRequirement + (level
     * × 1.5)
     *
