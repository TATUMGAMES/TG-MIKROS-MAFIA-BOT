...
/**
 * Catalog of all bosses in the RPG system. Contains 48 normal bosses (4 per level for levels 1-12)
 * and 20 super bosses.
 */
public class BossCatalog {
   ...
   * @param level the boss level
   * @param livableSeconds time in seconds until boss expires (e.g.
   *     BossService.getLivableIntervalSeconds())
   ...
   */
  public static SuperBoss createSuperBoss(
      SuperBossDefinition definition, int level, long livableSeconds) {
    int maxHp = 50000 * level;
    int attack = 200 + (level * 50);
    String baseId =
        "superboss_" + definition.name.toLowerCase().replaceAll("\\s+", "_") + "_" + level;
    String bossId = baseId + "_" + UUID.randomUUID().toString().substring(0, 8);
  ...
  private static void initializeNormalBosses() {
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Frostbite Shade",
                BossType.SPIRIT,
                "A wandering spirit from the Spirit Veil, drawn to the warmth of living souls."),
            new BossDefinition(
                "Icebound Bandit",
                BossType.HUMANOID,
                "A desperate marauder who found refuge in the frozen wastes of Nilfheim.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Glacial Wraith",
                BossType.SPIRIT,
                "A spirit bound to the ice, forever searching for its lost warmth."),
            new BossDefinition(
                "Frozen Marauder",
                BossType.HUMANOID,
                "A warrior encased in ice, still fighting battles long forgotten.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Frostweaver",
                BossType.ELEMENTAL,
                "A master of the Frost element, weaving ice into deadly patterns."),
            new BossDefinition(
                "Rimebound Berserker",
                BossType.HUMANOID,
                "A warrior driven mad by the endless cold, seeking warmth in battle.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Void-Touched Servitor",
                BossType.ELDRITCH,
                "A servant of the deep void, speaking in fractal whispers."),
            new BossDefinition(
                "Stormcaller",
                BossType.ELEMENTAL,
                "A being of pure Gale energy, commanding the winds of Nilfheim."),
            new BossDefinition(
                "Grave Warden",
                BossType.UNDEAD,
                "Guardian of ancient burial grounds, risen to protect the dead.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Ember Drake",
                BossType.DRAGON,
                "A dragon of fire trapped in ice, its rage burning eternal."),
            new BossDefinition(
                "Void Walker",
                BossType.ELDRITCH,
                "A creature that phases between the Mortal and Arcane Veils.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Frostborne Champion",
                BossType.HUMANOID,
                "A legendary warrior from the ancient Frostborne civilization."),
            new BossDefinition(
                "Crystal Leviathan",
                BossType.CONSTRUCT,
                "A massive construct of living crystal, awakened by the Shattering.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            new BossDefinition(
                "Plague Herald", BossType.DEMON, "Bringer of pestilence, whisperer of corruption."),
            new BossDefinition(
                "Shiverheart Basilisk", BossType.BEAST, "Its gaze freezes both flesh and courage."),
            new BossDefinition(
                "Astral Seer",
                BossType.SPIRIT,
                "A spirit that glimpses possible futures through the Astral element."),
            new BossDefinition(
                "Forge Master",
                BossType.CONSTRUCT,
                "An ancient automaton that repairs itself and others in battle.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Soul Harvester",
                BossType.UNDEAD,
                "Steals the essence of fallen heroes, growing stronger with each soul."),
            new BossDefinition(
                "Storm King",
                BossType.DRAGON,
                "A dragon that commands the Gale element, unleashing area-of-effect lightning.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            new BossDefinition(
                "Frostwraith Matriarch",
                BossType.SPIRIT,
                "A powerful mother-wraith mourning her long-lost children."),
            new BossDefinition(
                "Dreadhorn Minotaur", BossType.BEAST, "A labyrinth guardian forged from icy rage."),
            new BossDefinition(
                "Corrupted Titan",
                BossType.GIANT,
                "A titan twisted by dark magic, growing stronger as its wounds mount."),
            new BossDefinition(
                "Void Archon",
                BossType.ELDRITCH,
                "A being of pure void energy, phasing in and out of reality.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            new BossDefinition(
                "Polar Hydra", BossType.DRAGON, "Three snapping heads, one frozen heart."),
            new BossDefinition(
                "Soulflayer Acolyte",
                BossType.HUMANOID,
            ...
            new BossDefinition(
                "The Frostweaver",
                BossType.ELEMENTAL,
                "Manipulates the battlefield itself, creating and destroying terrain."),
            new BossDefinition(
                "Grand Librarian",
                BossType.HUMANOID,
                "A keeper of forbidden knowledge from the Grand Library of Nil City.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            ...
            new BossDefinition(
                "Crystalbound Dragonspawn",
                BossType.DRAGON,
                "Fragments of an ancient dragon reforged by frozen magic."),
            new BossDefinition(
                "Starfall Guardian",
                BossType.CONSTRUCT,
                "A construct from Starfall Ridge, powered by fallen star fragments."),
            new BossDefinition(
                "Moonspire Keeper",
                BossType.SPIRIT,
                "Guardian of the Moonspire Obelisk, keeper of ancient runic magic.")));
    ...
    NORMAL_BOSSES.put(
        ...
        Arrays.asList(
            new BossDefinition(
                "The Rime Executioner",
                BossType.HUMANOID,
                "A sentient suit of armor possessed by an ice spirit."),
            new BossDefinition(
                "Warden of the Shattered Gate",
                BossType.ELDRITCH,
                "Stands watch over a forgotten portal leading into nothingness."),
            new BossDefinition(
                "Frostgate Warlord",
                BossType.HUMANOID,
                "A legendary warrior from Frostgate, master of the Frostborne techniques."),
            new BossDefinition(
                "The Shattering Remnant",
                BossType.ELDRITCH,
                "A fragment of the cataclysm that created the Shattering of the First Winter.")));
  }

  private static void initializeSuperBosses() {
    SUPER_BOSSES.add(
        new SuperBossDefinition(
            "Ymir the Winterbound Colossus",
            BossType.GIANT,
    ...
    SUPER_BOSSES.add(
        new SuperBossDefinition(
            "Kalgorath, Harbinger of the Void Star",
            BossType.ELDRITCH,
  ...
  /**
   * Gets "The Unity Devourer" boss definition. This is a special boss that spawns every 10 normal
   * boss defeats.
   *
   * @param level the boss level
  ...
  public record BossDefinition(
      String name, BossType type, String lore, boolean hasClassHarmonyMechanic) {
  ...
  public record SuperBossDefinition(
      String name,
      BossType type,
      String lore,
