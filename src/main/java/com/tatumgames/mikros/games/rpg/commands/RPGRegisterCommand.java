...
public class RPGRegisterCommand implements CommandHandler {
  ...
  public void handle(SlashCommandInteractionEvent event) {
    ...
    if (characterService.hasCharacter(guildId, userId)) {
      if (characterService.canReregisterAfterDeath(guildId, userId)) {
        characterService.archiveAndRemoveActive(guildId, userId);
    ...
    try {
      RPGCharacter character =
          characterService.registerCharacter(guildId, userId, name, characterClass);
