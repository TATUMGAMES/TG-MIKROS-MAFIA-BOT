...
/**
 * Enum representing crafted items that grant permanent stat bonuses. Each item requires essences
 * and a catalyst to craft.
 */
public enum CraftedItemType {
    EMBER_INFUSION(
            "Ember Infusion", "🔥", EssenceType.EMBER_SHARD, 5, CatalystType.ANCIENT_VIAL, 1, "STR", 1),
    GALE_ETCHING(
            "Gale Etching", "🌪️", EssenceType.GALE_FRAGMENT, 5, CatalystType.ANCIENT_VIAL, 1, "AGI", 1),
    MIND_SIGIL(
            "Mind Sigil", "🔮", EssenceType.MIND_CRYSTAL, 4, CatalystType.RUNIC_BINDING, 1, "INT", 1),
    CHARM_OF_FORTUNE(
            "Charm of Fortune",
            "🍀",
