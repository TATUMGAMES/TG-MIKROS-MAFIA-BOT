...
/**
 * Enum defining all available titles in the RPG system. Titles are categorized by type: Progress,
 * Feat, First-To, Pattern, and Community.
 */
public enum Title {
    ...
    GRAVECALLER(
            "Gravecaller", 0, TitleType.FEAT, 0.02), // 50 resurrections performed (2% drop chance bonus)
    WANDERER("Wanderer", 0, TitleType.FEAT, 0.02), // 500 explores (2% exploration drop bonus)
    THE_DISCIPLINED(
            "The Disciplined", 0, TitleType.FEAT, 0.02), // Trainer pattern (2% training stat bonus)
    THE_EXPLORER(
            "The Explorer", 0, TitleType.FEAT, 0.02), // Explorer pattern (2% exploration XP bonus)
    ...
    SECRET_CHALLENGER(
            "Secret Challenger", 0, TitleType.FEAT, 0.02), // 5 secret bosses defeated (2% XP bonus)

    // First-To Titles (Myth tier, cosmetic + aura unlock)
    FIRST_BLOOD_OF_NILFHEIM(
            "First Blood of Nilfheim", 0, TitleType.FIRST_TO, 0.0), // First boss kill ever
    THE_ONE_WHO_FELL_AND_RETURNED(
            "The One Who Fell and Returned", 0, TitleType.FIRST_TO, 0.0), // First to die 10 times
    VOICE_OF_THE_FROZEN_WORLD(
            "Voice of the Frozen World", 0, TitleType.FIRST_TO, 0.0), // Song of Nilfheim holder
    ...
    // Community Titles
    BEARER_OF_BURDENS(
            "Bearer of Burdens", 0, TitleType.COMMUNITY, 0.0), // 10+ charges donated (cosmetic)
    ...
    CURSEWALKER(
            ...
            0,
            TitleType.FEAT,
            0.0), // Acted during both Minor + Major curse simultaneously
    LIGHTBEARER(
            "Lightbearer",
            0,
            TitleType.FEAT,
            0.02), // Priest: 10 resurrections during cursed worlds (2% resurrection XP bonus)
    BOUND_TO_DEATH(
            "Bound to Death", 0, TitleType.FEAT, 0.0), // Necromancer: Active during March of the Dead
    ...
    THE_UNSWORN(
            ...
            0,
            TitleType.FEAT,
            0.02), // Reach 10 corruption without embracing (2% damage bonus)
    MARKED_BY_SILENCE(
            "Marked by Silence",
            0,
            TitleType.FEAT,
            0.02), // Refuse all gods and survive to level 15 (2% XP bonus)
    BREAKER_OF_CHAINS(
            "Breaker of Chains",
            0,
            TitleType.FEAT,
            0.02), // Defeat super boss at max corruption (2% boss damage bonus)
    THE_CONTESTED(
            "The Contested",
            0,
            TitleType.FEAT,
            0.02); // Trigger 3 backlash events and survive (2% corruption bonus)
