...
public class BumpStats {
    ...
    public int getTotalBumps() { return totalBumps; }
    public int getBumpsThisMonth() { return bumpsThisMonth; }
    public int getBumpsThisWeek() { return bumpsThisWeek; }
    public Map<BumpConfig.BumpBot, Integer> getBumpsPerBot() { return bumpsPerBot; }
    public Map<BumpConfig.BumpBot, Instant> getLastBumpTime() { return lastBumpTime; }
    public List<BumpRecord> getRecentBumps() { return recentBumps; }
    ...
    public static class BumpRecord {
        ...
        public BumpConfig.BumpBot getBot() { return bot; }
