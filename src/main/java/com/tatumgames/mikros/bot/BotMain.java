...
public class BotMain extends ListenerAdapter {
  ...
  private static final Set<String> SCRAMBLE_COMMANDS_FOR_ACTIVITY =
      Set.of("scramble-guess", "scramble-stats", "scramble-leaderboard", "scramble-profile");
  ...
  public BotMain() {
    ...
    this.nilfheimEventScheduler =
        new NilfheimEventScheduler(nilfheimEventService, characterService, bossScheduler);
    this.rpgGuildResetService =
        new RpgGuildResetService(
            characterService,
            bossService,
            worldCurseService,
            blessingService,
  ...
  private void registerCommandHandlers() {
    ...
    registerHandler(new GameConfigCommand(wordUnscrambleService, wordUnscrambleResetScheduler));
    ...
    registerHandler(
        new RPGSetupCommand(
            characterService, rpgGuildResetService, bossScheduler, nilfheimEventScheduler));
    registerHandler(new RPGConfigCommand(characterService, rpgGuildResetService));
    registerHandler(new RPGResetCommand(characterService, rpgGuildResetService));
    registerHandler(
        new RPGResetAccountCommand(characterService, bossService, achievementService, auraService));
