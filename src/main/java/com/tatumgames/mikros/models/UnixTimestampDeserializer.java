...
/**
 * Custom deserializer for date strings in format dd-MM-yy:HH:mm:ss to Instant. Example:
 * "29-11-25:08:56:40" = November 29, 2025 at 08:56:40
 */
    ...
    public Instant deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        try {
            ...
            throw new IOException(
                    "Failed to parse date: " + dateString + ". Expected format: dd-MM-yy:HH:mm:ss", e);
        }
    }
}
