...
public class PromotionStepManager {
    ...
    public Instant calculateStepTargetTime(Instant campaignStartDate, Instant campaignEndDate, int step) {
        ...
        return switch (step) {
            case 1 -> campaignStartDate; // Step 1: At campaign start
            case 2 -> campaignStartDate.plus(campaignDurationHours / 3, ChronoUnit.HOURS); // Step 2: 33% through
            case 3 -> campaignStartDate.plus(campaignDurationHours * 2 / 3, ChronoUnit.HOURS); // Step 3: 66% through
            case 4 -> campaignStartDate.plus(campaignDurationHours * 9 / 10, ChronoUnit.HOURS); // Step 4: 90% through
