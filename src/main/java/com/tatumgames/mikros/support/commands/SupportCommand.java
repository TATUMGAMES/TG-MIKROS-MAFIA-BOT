...
/**
 * Command handler for /support. Provides information about supporting the MIKROS Bot development.
...
public class SupportCommand implements CommandHandler {
  ...
  private static final String MIKROS_BOT_DONATION_MSG_3 =
      """
            ...
            """;
  private static final List<String> SUPPORT_MESSAGES =
      List.of(MIKROS_BOT_DONATION_MSG_1, MIKROS_BOT_DONATION_MSG_2, MIKROS_BOT_DONATION_MSG_3);
  ...
  public void handle(SlashCommandInteractionEvent event) {
    ...
    event
        ...
        .queue(
            success ->
                logger.info(
                    "Sent support message (version {}) to user {}",
                    SUPPORT_MESSAGES.indexOf(selectedMessage) + 1,
                    event.getUser().getId()),
