...
/**
 * Command handler for /info. Provides transparency and trust-building information about the MIKROS
 * Bot.
 */
public class InfoCommand implements CommandHandler {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        // Developer / Company
        embed.addField("👨‍💻 Bot Developer", "Tatum Games\n" + BotInfo.SUPPORT_EMAIL, false);

        // Version
        embed.addField("📦 Version", BotInfo.VERSION, true);
