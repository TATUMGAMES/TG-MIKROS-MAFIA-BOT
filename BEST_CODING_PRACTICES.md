...
This document defines the **best practices and coding standards** to be followed when contributing to the `TG-MIKROS-BOT` Discord bot. All code should be **clean, modular, testable, and maintainable**. These rules are intended to guide both human and AI contributors (such as Cursor AI) to write production-grade code.
